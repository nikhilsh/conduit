...
implemented in the canonical prototype as the `ConduitMark` React component — see
`kit.jsx` (repo root). It accepts a `size` and an optional flat `color` (when tinting an
