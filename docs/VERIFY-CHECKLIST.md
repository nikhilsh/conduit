...
**Apple Watch ask notification actions + subagents earlier-agents collapse + voice pause fix + pull-to-refresh sessions + pending-chat reconnect fix.** PRs #743 (iOS + broker + relay), #748 (iOS + Android), #749 (iOS + Android), #750 (iOS + Android), #751 (iOS + Android).
