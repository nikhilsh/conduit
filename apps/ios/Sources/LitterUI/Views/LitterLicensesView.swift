...
// MARK: - LitterLicensesView
//
// Static third-party attribution screen pushed from LitterSettingsView →
            ...
            Link(destination: entry.url) {
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text(entry.url.absoluteString)
                        ...
                        .foregroundStyle(LitterUI.Palette.textMuted.color.opacity(0.8))
                        .lineLimit(1)
